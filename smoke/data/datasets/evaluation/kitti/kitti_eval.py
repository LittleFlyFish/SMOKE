...
def do_kitti_detection_evaluation(dataset,
    ...
    for image_id, prediction in predictions.items():
        ...
        print('the test for predict_txt:')
        print(prediction)
        print(predict_txt)
    ...
    os.chdir(root + 'smoke/data/datasets/evaluation/kitti/kitti_eval')
    ...
    command = root + 'smoke/data/datasets/evaluation/kitti/kitti_eval/' + "evaluate_object_3d_offline {} {}".format("/soe/SMOKE/"+label_dir, output_dir)
